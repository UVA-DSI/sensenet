...
// TTN credentials are located in 'ttn-credentials.h'
// DISABLE_JOIN must be set in 'arduino-lmic/project_config/lmic_project_config.h'
...
void setup() {
    ...
    LMIC_reset();
    // static session parameters for ABP
