...
// LED strip conf
#define DATA_PIN           3    // redefine
//#define CLK_PIN          4    
#define LED_TYPE           WS2811
#define COLOR_ORDER        GRB
#define NUM_LEDS           64    
CRGB leds[NUM_LEDS];
#define FRAMES_PER_SECOND  120  // redefine
...
#define MIC_TIMING_SHIFT  1           // Set to one to fix MSB timing for some microphones, i.e. SPH0645LM4H-x
...
// define MQTT topics
#define SENSOR1_TOPIC   "/ostenda0/tree0/dBA"
...
void loop() {
  ...
  // LED brightness based on db(A)
  // TODO: define the scale X...Y
  switch (int(Leq_dB)) {
    case 35 ... 40:
    ...
    case 71 ... 80:
      ...
      Serial.print("level: 140");
      break;
    case 81 ... 90:
      FastLED.setBrightness(180);
      Serial.print("level: 180");
      break;
    case 91 ... 100:
      FastLED.setBrightness(220);
      Serial.print("level: 220");
      break;  
    case 101 ... 135:
